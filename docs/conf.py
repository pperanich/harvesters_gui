...
latex_documents = [
    (master_doc, "Harvester.tex", "Harvester Documentation", "EMVA", "manual"),
]
...
man_pages = [(master_doc, "harvesters", "Harvester Documentation", [author], 1)]
